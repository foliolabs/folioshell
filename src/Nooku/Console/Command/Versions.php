...
class Versions extends Command
{
    ...
    protected function configure()
    {
        ...
        $this
            ->setName('versions')
            ->setDescription('Show available versions from the WordPress Git mirror')
            ->addOption(
                'refresh',
                null,
    ...
    public function refresh()
    {
        ...
        $result = `git ls-remote https://github.com/WordPress/WordPress.git | grep -E 'refs/(tags|heads)' | grep -v '{}'`;
