...
Extension\Symlink::registerSymlinker(function($project, $destination, $name, $projects, OutputInterface $output) {
    ...
    if (!isset($manifest->extra) || !isset($manifest->extra->{'foliokit-component'})) {
        return false;
    }

    $component   = $manifest->extra->{'foliokit-component'};
    $code_folder = $destination.'/wp-content/plugins/foliokit-components';
